  ...
  const [{ data: statuses }, { data: submissions }, { data: closuresRow }, { data: tiers }, { data: messages }] =
    await Promise.all([
      ...
      supabase.from("submissions")
        .select("id, candidate_name, linkedin_url, requirement_id, current_status_id, submitted_date, current_company, current_title, total_experience, current_location, resume_url, candidate_photo_url, requirements(title)")
